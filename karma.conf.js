...
module.exports = function (config) {
  config.set({
    ...
    files: [
     ...
     // { pattern:'node_modules/@angular/tsc-wrapped/**/*.js', included: false, watched: false},
      // RxJs.
      ...
      { pattern: 'node_modules/validator/**/*.js', included: false, watched: false },
      { pattern: 'node_modules/hammerjs/hammer.min.js', included: true, watched: false},
      { pattern: 'node_modules/@angular/material/prebuilt-themes/purple-green.css', included: true, watched: false},

      { pattern: 'dist/dev/**/*.js', included: false, watched: true },
      { pattern: 'dist/testing-artifacts/**/*.js', included: false, watched: true },
    ...
    exclude: [
    "/base/node_modules/node_modules/**/*specs.js",
    ...
    // level of logging
    // possible values: app-env.LOG_DISABLE || app-env.LOG_ERROR || app-env.LOG_WARN || app-env.LOG_INFO || app-env.LOG_DEBUG
