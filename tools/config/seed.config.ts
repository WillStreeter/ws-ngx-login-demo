 ...
 * in project.server-app-env.ts. If you need to change any tasks
...
export class SeedConfig {
   ...
   * default build type is `dev`, which can be overriden by the `--build-type dev|prod` flag when running `npm start`.
   */
  ...
  */
  ...
  /**
   * The folder of the mock data for testing-artifacts
   */
  MOCK_SRC = 'src/testing-artifacts';
  ...
  /**
   * The folder for the built files of the mock data for testing-artifacts.
   * @type {string}
   */
  MOCK_TESTING_DEST = `${this.DIST_DIR}/testing-artifacts`;
  ...
  */
  ...
  SYSTEM_CONFIG_DEV: any = {
    ...
    paths: {
      ...
      'angular-in-memory-web-api':'node_modules/angular/bundles/in-memory-web-api.umd.umd.js',
  ...
  */
  ...
  /**
   * Configurations for NPM module configurations. Add to or override in project.server-app-env.ts.
   * @type {any}
   */
  PLUGIN_CONFIGS: any = {};
